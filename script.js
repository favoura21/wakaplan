...
document.addEventListener('DOMContentLoaded', () => {
  const typewriterElement = document.getElementById('typewriter-text1');
  if (typewriterElement) {
    const messages = [
      'From weddings to concerts, secure the perfect venue, stress-free with WakaPlan.',
      'Your Event, No Stress. Find Trusted Vendors on WakaPlan.',
      'Plan your perfect event with trusted Nigerian vendors on WakaPlan.',
      'From DJs to decorators, book quality vendors with WakaPlan.',
      'Make your event unforgettable with professional vendors on WakaPlan.',
      'Stress-free event planning with verified vendors on WakaPlan.',
      'Your dream event starts here with trusted vendors on WakaPlan.'
    ];
        ...
        <div class="col-lg-4 col-md-6">
          <a href="?user_id=${v.user_id}" class="card-link">
            <div class="card vendor-card h-100">
              <img src="${getVendorProfileImage(v)
    }"
